...
@interface DBObtainViewController ()

@end

@implementation DBObtainViewController
...
- (void)viewDidLoad {
    ...
    [labelButton setTitle:@"Obtain  goods" forState:UIControlStateNormal];
