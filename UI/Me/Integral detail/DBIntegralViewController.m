...
@interface DBIntegralViewController ()

@end

@implementation DBIntegralViewController
...
- (void)viewDidLoad {
    ...
    [labelButton setTitle:@"Integral  address" forState:UIControlStateNormal];
