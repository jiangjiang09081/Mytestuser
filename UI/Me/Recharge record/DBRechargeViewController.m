...
@interface DBRechargeViewController ()

@end

@implementation DBRechargeViewController
...
- (void)viewDidLoad {
    ...
    [labelButton setTitle:@"Recharge  record" forState:UIControlStateNormal];
