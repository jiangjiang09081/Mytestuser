...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.pullToRefreshView) {
        SVPullToRefreshView *view = [[SVPullToRefreshView alloc] initWithFrame:CGRectMake(30, -SVPullToRefreshViewHeight, self.bounds.size.width, SVPullToRefreshViewHeight)];
